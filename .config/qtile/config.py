...
keys = [
         ...
         Key([mod, "mod1"], "s",
             lazy.spawn(myTerm+" -e systemctl hybrid-sleep"),
             ),
	### Special keys.
        ...
        Key([], "XF86AudioMedia",
            lazy.spawn("alacritty -e ncmpcpp")
            ),
        Key([], "XF86TouchpadToggle",
            lazy.spawn("synclient | grep 'TouchpadOff.*1' && synclinet TouchpadOff=0 || synclient TouchpadOff=1")
            ),
        Key([], "XF86TouchpadOn",
            lazy.spawn("synclient TouchpadOff=0")
            ),
        Key([], "XF86TouchpadOff",
            lazy.spawn("synclient TouchpadOff=1")
            ),
